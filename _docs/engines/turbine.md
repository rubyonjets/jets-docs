...
A `Jets::Turbine` provides hooks to extend Jets and or modify the initialization process at a simpler and lower level than a full [Jets Engine]({% link _docs/engines/engine.md %}). If you're coming from the Rails world, a Jets Turbine is similar to a Rails Railtie.

This is useful if you want to develop a third party extension for Jets like [sentry-jets](https://github.com/tongueroo/sentry-jets).
