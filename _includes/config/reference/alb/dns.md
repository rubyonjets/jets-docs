...
alb.dns.hosted_zone_name | nil | The hosted zone name. Setting `alb.dns.domain` is preferred over `alb.dns.hosted_zone_name` since it's easier to read and debug.
